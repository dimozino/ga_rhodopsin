...
ini_step = population.initial_step(population) + 1
sets, pulls, probs = read_replacements('sites')

iteration, step, stop_step = 2, 0, 10
...
while step < stop_step:
    ...
    population.mutation(attempts=4000, iteration=iteration, sets=sets, pulls=pulls, probs=probs)
    population.compute()
